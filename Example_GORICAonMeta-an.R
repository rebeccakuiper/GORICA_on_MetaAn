...
#Results:
#  model  loglik  penalty   gorica  gorica.weights
#1          H1  10.119    2.806  -14.625           0.708
#2  complement  10.119    3.693  -12.851           0.292
#---
#  The order-restricted hypothesis ‘H1’ has  2.428 times more support 
#                                                 than its complement.
#
...
#Results:
#  model  loglik  penalty   gorica  gorica.weights
#1      H1_mod  13.880    3.500  -20.760           0.552
#2  complement  13.672    3.500  -20.344           0.448
#---
#  The order-restricted hypothesis ‘H1_mod’ has  1.231 times more support 
#                                                     than its complement.
#
#
...
#Results:
#  model  loglik  penalty   gorica  gorica.weights
#1  H1_mod_res  13.880    3.500  -20.760           0.552
#2  complement  13.672    3.500  -20.344           0.448
#---
#  The order-restricted hypothesis ‘H1_mod_res’ has  1.231 times more support  
#                                                         than its complement.
...
#  Results:
#  model  loglik  penalty  gorica  gorica.weights
#1         H12   3.276    4.105   1.658           0.572
#2  complement   3.276    4.395   2.237           0.428
#---
#  The order-restricted hypothesis ‘H12’ has  1.336 times more support 
#                                                  than its complement.
#
#Restriktor message: Since the constraint matrix is not full row-rank, 
#the level probabilities are calculated using mix.weights = "boot" 
...
#For more information see ?restriktor.
#
# Hence, no compelling support for H12.
...
#  Results:
#        model  loglik  penalty  gorica  gorica.weights
#1         H3a   8.338    4.500  -7.677           1.000
#2  complement   0.103    4.500   8.794           0.000
#---
#  The order-restricted hypothesis ‘H3a’ has 3773.205 times more support 
#                                                  than its complement.
